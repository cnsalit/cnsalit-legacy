...
<div style="margin-top:1.6VW;" >
    ...
    <div class="carousel-inner">
        <div class="carousel-item active"><img style="width:100% ;height:14VW" src="assets/img/care3.jpg" alt="Slide One ;"></div>
        ...
        <div class="carousel-item"><img style="width:100% ;height:14VW" src="assets/img/care8.png" alt="Slide One;"</div>
    ...
    <a class="carousel-control-next" href="#carousel"  data-slide="next">
        ...
        <tr >
            ...
            <td  onclick="location.href='UploadCritic.aspx'" <%--onclick="alert('현재는 비평할 수 없습니다.')"--%> style="cursor:pointer;background-image:url('/assets/img/critic.jpg'); background-size:contain;" >
            </td>
