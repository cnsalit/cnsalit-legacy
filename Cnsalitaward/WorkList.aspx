    ...
    <body style="user-select: none; width: 100vw;">
        ...
        <div style="width: 100vw; overflow-x: hidden;">
            ...
            <%
                ...
                /*void writeWork(Cnsalitaward.Models.Work work)
                {
                    //writeWork
                    if (isAdmin)
           ...
           if (pageCount / 10 == page / 10)
           {
               if (page % 10 != 0)
               {
                   for (int i = 1; i <= pageCount % 10; i++)
                   {
                       ...
                       Response.Write("<a" + textStyle + " href=\"/WorkList?page=" + (i + ((page / 10) * 10)) + queryText + "\">" + (i + ((page / 10) * 10)) + "</a>");
                       Response.Write("</span>");
                   }
               }
               else
               {
                   ...
                   for (int i = 1; i <= 10; i++)
                   {
                       ...
                       Response.Write("<span" + pageStyle + " style=\"padding: 0.15VW 0.46VW; margin: 0.15VW;\">");
                       Response.Write("<a" + textStyle + " href=\"/WorkList?page=" + (i + page - 10) + queryText + "\">" + (i + page - 10) + "</a>");
                       Response.Write("</span>");
                   }
               }
           }
       ...
       else
       {
           ...
           for (int i = 1; i <= 10; i++)
           {
               ...
               Response.Write("<span" + pageStyle + " style=\"padding: 0.15VW 0.46VW; margin: 0.15VW;\">");
               Response.Write("<a" + textStyle + " href=\"/WorkList?page=" + i + queryText + "\">" + i + "</a>");
               Response.Write("</span>");
           }
       }
