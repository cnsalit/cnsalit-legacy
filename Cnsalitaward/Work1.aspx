    ...
    <body style="user-select: none;">
        ...
        <div class="body">
            ...
            <div class="maintext">
                ...
                <div style="color:#707070;margin-top:2vw;font-size:2vw" class="NotoB">댓글 <span runat="server" id="replyNum">fff</span>개</div>
                ...
                <%  
                    ...
                    foreach (var reply in workList)
                    {
                        ...
                        if (reply.UserID == User || Admin != "admin") Response.Write("<a onclick=\"pop('DeleteReply.aspx?Id=" + reply.Id + "&Kind=verse&Work=" + work.Id + "','','width=418,height=125;location=no,resizable=no')\" style=\"margin-left:1vw;cursor:pointer;color:red;\">X과연삭제가보이나</a>");
